...
import {getStringCV, levenstein} from "./src/lib/StringComparison.js";
...
Logger.startTimed()
console.log(getStringCV("SADFASDGASDFASDASDFSADFASDFASDFSAFs".repeat(100), "SADF12224DFSADFASD867asdfasDFASFASDFSAFs".repeat(100)));
Logger.result("took " + Logger.endTimed() + "ms", this);
Logger.startTimed()
console.log(levenstein("SADFASDGASDFASDASDFSADFASDFASDFSAFs".repeat(100), "SADF12224DFSADFASD867asdfasDFASFASDFSAFs".repeat(100)));
Logger.result("took " + Logger.endTimed() + "ms", this);
...
new GeneratedDiffEvaluation([new QualityCpeeDiffAdapter(), new BalancedCpeeDiffAdapter(), new FastCpeeDiffAdapter(), new XyDiffAdapter(), new DiffXmlAdapter(), new XccAdapter()]).standardSingle();
