...
TestConfig.EXECUTION_OPTIONS.timeout = 300000*1000;
...
//new GeneratedDiffEvaluation([new FastCpeeDiffAdapter(), new BalancedCpeeDiffAdapter(),  new QualityCpeeDiffAdapter(), new XyDiffAdapter(), new XccAdapter()]).standardSingle();
