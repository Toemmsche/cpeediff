...
EvalConfig.EXECUTION_OPTIONS.timeout = 10 * 1000;
EvalConfig.RUN_AUTOGENERATED_TESTS = true;
DiffConfig.LOG_LEVEL = 'error';
...
//new GeneratedDiffEvaluation([new CpeeDiffLocalAdapter('quality')]).average(false, false);
//new DiffEvaluation([new DiffXmlAdapter(), new CpeeDiffAdapter(('quality'))]).evalAll(EvalConfig.MATCH_CASES_DIR + "/move/interparent_move");
new MergeEvaluation([new CpeeMergeAdapter(), new XccPatchAdapter(), new _3dmAdapter()]).evalAll();
