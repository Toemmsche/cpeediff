...
TestConfig.EXECUTION_OPTIONS.timeout = 3000000000000000000*1000;
TestConfig.RUN_AUTOGENERATED_TESTS = true;
Logger.enableLogging();

//GeneratedMatchEvaluation.all().standardSingle();
//DiffAlgorithmEvaluation.all().evalAll();
new GeneratedDiffEvaluation([new BalancedCpeeDiffAdapter(), new FastCpeeDiffAdapter(), new QualityCpeeDiffAdapter()]).standardAggregate();
