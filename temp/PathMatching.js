...
const {Comparator} = require('../src/diff/match/Comparator.js');
const {Lcs} = require('../src/diff/lib/Lcs.js');
const {DiffConfig} = require('../src/config/DiffConfig.js');
const {MatcherInterface} = require('../src/diff/match/MatcherInterface.js');
const {Matching} = require('../src/diff/match/Matching.js');
