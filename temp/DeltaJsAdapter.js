...
import {DiffAdapter} from '../src/eval/diff_adapters/DiffAdapter.js';
import xmldom from '@xmldom/xmldom';
import {DomHelper} from '../src/util/DomHelper.js';
import {Node} from '../src/tree/Node.js';

export class DeltaJsAdapter extends DiffAdapter {

  constructor() {
    super(EvalConfig.DIFFS.DELTAJS.path, EvalConfig.DIFFS.DELTAJS.displayName);
  }
