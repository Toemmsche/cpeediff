        ...
        fs.readdirSync(caseDir).forEach((caseCategory) => {
            ...
            fs.readdirSync(categoryDir).forEach((dir) => {
                ...
                if (dir.startsWith("gen_")) {
                    ...
                    if (!TestConfig.RUN_AUTOGENERATED_TESTS || !fs.existsSync(categoryDir + "/" + dir + "/" + TestConfig.GEN_PARAMS_FILENAME)) {
                        return;
                    }
                    const genParamsJson = fs.readFileSync(categoryDir + "/" + dir + "/" + TestConfig.GEN_PARAMS_FILENAME).toString();
                    ...
                    if (fs.existsSync(categoryDir + "/" + dir + "/" + TestConfig.CHANGE_PARAMS_FILENAME)) {
                        const changeParamsJson = fs.readFileSync(categoryDir + "/" + dir + "/" + TestConfig.CHANGE_PARAMS_FILENAME).toString();
